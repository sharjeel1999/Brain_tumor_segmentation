...
class DoubleConv(nn.Sequential):
    ...
    def __init__(self, in_channels, out_channels, encoder, kernel_size=3, order='gcr', num_groups=8, padding=1,
        ...
        self.add_module(nn.Dropout3d(0.2))
...
class AbstractUNet(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, final_sigmoid, basic_module, f_maps=64, layer_order='gcr',
        ...
        self.reduction_conv1 = nn.Conv3d(64, 16, kernel_size = 3, padding = 1)
    ...
    def forward(self, x):
        ...
        for i, encoder in enumerate(self.encoders):
            ...
            # print(i, ' ', x.shape)
            # if x.shape[4] == 32:
            #     feats1 = self.reduction_conv1(feats1)
            #     print('combination shapes: ', x.shape, feats1.shape)
            #     x = x + feats1
        ...
        # print('len encoded features: ', len(encoders_features))
        # encoders_features[0] += mid_feats
        # print('encoded feats shape: ', encoders_features[0].shape, encoders_features[1].shape, encoders_features[2].shape)
        # decoder part
