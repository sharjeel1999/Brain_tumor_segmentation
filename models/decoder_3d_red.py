...
class Decoder_3D_red(nn.Module):
    def __init__(self, n_channels, n_classes, bilinear=False):
        super(Decoder_3D_red, self).__init__()
        ...
        self.up1 = (Up_3d(512, 256, bilinear))
        self.up2 = (Up_3d(256, 128, bilinear))
        self.up3 = (Up_3d(128, 64, bilinear))
        self.up4 = (Up_3d(64, 32, bilinear))
        self.outc = (OutConv_2d(32*96, n_classes))
