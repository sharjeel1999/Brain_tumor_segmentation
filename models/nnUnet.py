...
class Down_Residual_block(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size = (3, 3, 3), stride = (1, 1, 1), padding = 1):
...
class Transposed_conv(nn.Module):
    def __init__(self, in_channels, out_channels):
        ...
        self.bn = nn.BatchNorm3d(in_channels)
        self.act = nn.LeakyReLU()      
        self.trans = nn.ConvTranspose3d(in_channels, out_channels, kernel_size = (3, 3, 3), stride = (2, 2, 2), padding = 1)
...
class Encoder(nn.Module):
    def __init__(self, in_channels, inter_channels):
        ...
        self.down_res_d2 = Down_Residual_block(inter_channels, int(inter_channels*2), kernel_size = (3, 3, 3), stride = (2, 2, 2))
        self.d2c2 = Const_Residual_block(int(inter_channels*2), int(inter_channels*2))
        
        self.down_res_d3 = Down_Residual_block(int(inter_channels*2), int(inter_channels*4), kernel_size = (3, 3, 3), stride = (2, 2, 2))
        ...
        self.down_res_d4 = Down_Residual_block(int(inter_channels*4), int(inter_channels*8), kernel_size = (3, 3, 3), stride = (2, 2, 2))
        ...
        self.down_res_d5 = Down_Residual_block(int(inter_channels*8), int(inter_channels*16), kernel_size = (3, 3, 3), stride = (2, 2, 2))
        ...
        self.down_bottleneck = Down_Residual_block(int(inter_channels*16), int(inter_channels*32), kernel_size = (3, 3, 3), stride = (2, 2, 2))
    ...
    def forward(self, x):
        ...
        # print('model in x shape: ', x.shape)
        x1 = self.d1c2(x)
...
class nnUNet(nn.Module):
    def __init__(self, in_channels, num_classes, inter_channels):
        ...
        self.pred_layer_1 = nn.Conv3d(inter_channels, num_classes, kernel_size = 1)
        self.pred_layer_2 = nn.Conv3d(int(inter_channels*2), num_classes, kernel_size = 1)
        self.pred_layer_3 = nn.Conv3d(int(inter_channels*4), num_classes, kernel_size = 1)
        self.pred_layer_4 = nn.Conv3d(int(inter_channels*8), num_classes, kernel_size = 1)
